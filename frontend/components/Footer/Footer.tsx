...
const Footer = () => {
  return (
    <footer className="text-white-custom text-sm relative z-10 flex items-center justify-between py-3 px-5 md:p-4 bg-[#1C202DB2] text-gray-400 w-full mt-auto 3xl:py-3 xl:px-12 2xl:px-0 xl:py-4">
