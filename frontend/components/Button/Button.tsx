...
const Button = ({ text, active, className, disabled, type = "default", onClick }: ButtonProps) => {
  const classNames = clsx(
    "px-6  border-none text-white font-semibold leading-[18px] hover:cursor-pointer",
    // Type-specific styles
    type === "desktopmenu" && "lg:w-[326px] w-full h-[52px] px-6 rounded-[24px] border-none bg-[var(--button)] text-white text-[18px] font-semibold leading-[18px] hover:cursor-pointer hover:bg-[var(--button-hover)]",
    ...
    type === "portfolio" && "lg:w-[180px] w-[100px] h-[40px] text-base text-color-white bg-[#344F7342] rounded-[12px] flex items-center justify-center text-center p-2 hover:bg-[#344f7353]",
    type === "mobilemenu" && "w-full h-[52px] rounded-[24px] text-base bg-[rgba(52,79,115,0.26)] flex items-center justify-center text-center",
