...
const Button = ({ text, active, className, disabled, type = "default", onClick }: ButtonProps) => {
  const classNames = clsx(
    ...
    type === "desktopmenu" && "lg:w-[326px] w-full h-[52px] px-6 rounded-[24px] border-none bg-[#3B404F] text-white text-[18px] font-semibold leading-[18px] hover:cursor-pointer hover:bg-[var(--button-hover)] xl:transition-colors xl:duration-300 ",
    type === "service" && "lg:w-[125px] w-[105px] h-[40px] text-base bg-[#F6F6F652] hover:bg-[#344F7350] rounded-[12px]  flex items-center justify-center text-center p-3 self-end xl:transition-colors xl:duration-300 ",
    type === "portfolio" && "lg:w-[180px] w-[100px] h-[40px] text-base text-color-white bg-[#3B404F] rounded-[12px] flex items-center justify-center text-center p-2 hover:bg-[#344f7353] xl:transition-colors xl:duration-300 ",
